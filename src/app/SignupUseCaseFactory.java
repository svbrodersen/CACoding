...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, SignupUserDataAccessInterface userDataAccessObject) {
    ...
    private static SignupController createUserSignupUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, LoginViewModel loginViewModel, ClearViewModel clearViewModel, SignupUserDataAccessInterface userDataAccessObject) throws IOException {
        ...
        SignupOutputBoundary signupOutputBoundary = new SignupPresenter(viewManagerModel, signupViewModel, loginViewModel, clearViewModel);
